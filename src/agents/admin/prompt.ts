...
export function adminSoul(workspaceId: number): string {
  ...
  return [
    ...
    "This is a shared channel: multiple people talk to you here. Each user turn is prefixed with its author as `Name (slack:UID):` — treat that leading tag as the authoritative speaker and track who said what across the thread.",
