-- Enforce agents.name is a lowercase slug at the DB level.
...
-- with the CHECK constraint, then restore. No data is lost.
...
-- Step 3: recreate agents with CHECK(name = lower(name))
