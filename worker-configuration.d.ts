/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6b6722b35179681e7f22d3b364e8de6c)
// Runtime types generated with workerd@1.20260907.1 2026-03-02 nodejs_compat
interface __BaseEnv_Env {
	...
	GATEKEEPER_JWT_PRIVATE_KEY: string;
	...
	REACTION_WORKFLOW: Workflow<Parameters<import("./src/server").ReactionWorkflow['run']>[0]['payload']>;
	CANCEL_WORKFLOW: Workflow<Parameters<import("./src/server").CancelWorkflow['run']>[0]['payload']>;
	MAINTENANCE_WORKFLOW: Workflow<Parameters<import("./src/server").MaintenanceWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "GATEKEEPER_JWT_PRIVATE_KEY">> {}
}
