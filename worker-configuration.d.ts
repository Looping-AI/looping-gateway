/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 83eb05668ef879208af5a65945aacb2b)
// Runtime types generated with workerd@1.20260701.1 2026-03-02 nodejs_compat
interface __BaseEnv_Env {
	...
	LOCAL_MESSAGE_WORKFLOW: Workflow<Parameters<import("./src/server").LocalMessageWorkflow['run']>[0]['payload']>;
	REMOTE_MESSAGE_WORKFLOW: Workflow<Parameters<import("./src/server").RemoteMessageWorkflow['run']>[0]['payload']>;
